  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="antialiased bg-[var(--bg-primary)] text-[var(--text-primary)]">
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[var(--accent)] focus:text-black focus:rounded-lg focus:font-semibold">Skip to main content</a>
        {children}
      </body>
    </html>
  );
